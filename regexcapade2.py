...
# copied text data from mydata file
text_to_search_in = '''
Dave Martin
615-555-7164
...
# preparing the pattern to look for, in text to search
...
print(text_to_search_in[8457:8461])


print('*********************** PART 2  *************************')

pattern = re.compile(r'@(\w+)mail')
...
print(text_to_search_in[8808:8819])